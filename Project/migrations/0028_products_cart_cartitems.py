...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Project', '0027_remove_cartitems_cart_remove_cartitems_products_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('watch', 'Watch'), ('clothing', 'Clothing'), ('pants', 'Pants'), ('sneakers', 'Sneakers')], default='clothing', max_length=10)),
